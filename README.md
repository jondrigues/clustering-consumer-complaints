...
## Context
This repository is dedicated to the final graduation project of the specialization in Complex Data Mining provided by UNICAMP (Estadual de Campinas Universidade).
